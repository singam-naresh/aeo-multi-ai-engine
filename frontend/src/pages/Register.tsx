...
import { registerUser, storeToken, storeUser } from '../services/api.js';
          ...
          <div className="bg-card/40 border border-white/8 rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Start using AEO Engine for free</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">
                  Password <span className="text-muted-foreground/50 normal-case font-normal">(min 6 characters)</span>
                </label>
                <input
                  type="password"
                  value={password}
